...
typedef struct
{
	...
	lv_obj_t *scr_mbtn_m_label_grup_adi;
	...
	lv_obj_t *scr_ubtn_label_1;
	lv_obj_t *scr_ubtn_u_bar_cont;
	lv_obj_t *scr_ubtn_u_label;
...
LV_IMAGE_DECLARE(_printing_RGB565A8_96x54);
LV_IMAGE_DECLARE(_topla_RGB565A8_96x54);
...
LV_FONT_DECLARE(lv_font_Oswald_Reg_40)
LV_FONT_DECLARE(lv_font_Bebas_13)
LV_FONT_DECLARE(lv_font_Bebas_40)
LV_FONT_DECLARE(lv_font_Bebas_10)
LV_FONT_DECLARE(lv_font_Bebas_90)
LV_FONT_DECLARE(lv_font_Bebas_48)
LV_FONT_DECLARE(lv_font_Bebas_25)
LV_FONT_DECLARE(lv_font_Oswald_Reg_15)
LV_FONT_DECLARE(lv_font_Oswald_Reg_17)
LV_FONT_DECLARE(lv_font_Oswald_Reg_13)
LV_FONT_DECLARE(lv_font_Oswald_Reg_10)
