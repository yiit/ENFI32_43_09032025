...
extern const char kfont1[] PROGMEM;
extern const char kfont2[] PROGMEM;
extern const char kfont3[] PROGMEM;
extern const char kfont4[] PROGMEM;
extern const char kfont5[] PROGMEM;
extern const char kfont6[] PROGMEM;

extern const char font1[] PROGMEM;
extern const char font2[] PROGMEM;
extern const char font3[] PROGMEM;
extern const char font4[] PROGMEM;
extern const char font5[] PROGMEM;
extern const char font6[] PROGMEM;
extern const char sol[] PROGMEM;
extern const char orta[] PROGMEM;
extern const char sag[] PROGMEM;
extern const char beyaz[] PROGMEM;
extern const char siyah[] PROGMEM;
extern const char acik[] PROGMEM;
extern const char koyu[] PROGMEM;
extern const char kes[] PROGMEM;
extern const char logo[] PROGMEM;
extern const char logo58[] PROGMEM;
extern const char hata_beep[] PROGMEM;
extern const char okey_beep[] PROGMEM;
extern const char qrkodbas[] PROGMEM;
extern const char qrkodson[] PROGMEM;
extern const char cekmece[] PROGMEM;
extern const char CR[] PROGMEM;
extern const char LF[] PROGMEM;
extern const char etiketcal[] PROGMEM;
...
extern String XML_URUN_MESAJ_S;
...
extern unsigned long yazdir_iptal;
...
#endif
#ifndef LGFX_USE_LGFXFS
  #define LGFX_USE_LGFXFS 0   // ya da 1, proje tercihin
#endif
#endif
#include <lvgl.h>
...
#define DRAW_BUF_SIZE (TFT_HOR_RES * TFT_VER_RES * 2) // 1/10 ekran boyutu, 16 bit renk derinliği
//#define DRAW_BUF_SIZE (TFT_HOR_RES * 40)  // Partial update için öneri
...
enum EEPROM_Address : uint8_t {
    ...
    ADDR_NET_LABEL,
    ADDR_MAX = EEPROM_START_ADDR + 27 // 26 byte ayrıldı
};
...
// İsteğe bağlı: Sabit VID/PID tanımı (kullanmak isterseniz)
// #define PRINTER_VID  0x0FE6
// #define PRINTER_PID  0x8800

// Global değişkenleri burada "extern" olarak tanımlıyoruz
extern usb_host_client_handle_t client_hdl;
extern usb_device_handle_t dev_hdl;
extern uint8_t out_ep;
extern bool printer_ready;
// USB Host kurulumunu yapar (usb_host_setup)
void usb_host_setup();

// TSPL komutu göndermek için çağırabileceğiniz fonksiyon
void send_tspl_command(const char *cmd);

// Örnek bir etiket basma fonksiyonu (TSPL komutları)
void yazdirEtiket();

// Manuel olarak cihazları tarayıp (VID/PID eşleşmesi) yazıcı bulursa etiket basan örnek fonksiyon
