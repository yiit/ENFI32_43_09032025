...
LabelType::Enum SystemVariables2LabelType(SystemVariables::Enum enumval) {
  ...
  switch (enumval)
  {
    ...
    case SystemVariables::URUNNO:            label = LabelType::XML_URUN_NO; break;
    case SystemVariables::URUNISMI:          label = LabelType::XML_URUN_ISMI; break;
    case SystemVariables::URUNKOD:           label = LabelType::XML_URUN_KOD; break;
    case SystemVariables::URUNMESAJ:         label = LabelType::XML_URUN_MESAJ; break;
    ...
    case SystemVariables::PARTINO:           label = LabelType::XML_PARTI_NO; break;
    ...
    case SystemVariables::TOPADET:           label = LabelType::XML_TOP_ADET; break;    
    ...
    case SystemVariables::FIRMAISMI:         label = LabelType::XML_FIRMA_ISMI; break;
    case SystemVariables::PLAKANO:           label = LabelType::XML_PLAKA_NO; break;
    case SystemVariables::MUSTERIISMI:       label = LabelType::XML_MUSTERI_ISMI; break;
    case SystemVariables::OPERATORISMI:      label = LabelType::XML_OPERATOR; break;
    ...
    case SystemVariables::TOPLAM_DETAY:      label = LabelType::XML_TOPLAM_DETAY; break;
...
String SystemVariables::getSystemVariable(SystemVariables::Enum enumval) {
  ...
  switch (enumval)
  {
    ...
    case SKT:               return node_time.getDateStringPlusDays(urun_skt[sec_URUN_buton],'-');
...
SystemVariables::Enum SystemVariables::startIndex_beginWith(char beginchar)
{
  ...
  {
    case 'a': return Enum::ACIK;
    case 'b': return Enum::BARKOD;
    case 'c': return Enum::CEKMECE;
    case 'd': return Enum::DARA;
    case 'e': return Enum::EAN8;
#if FEATURE_ETHERNET
...
#endif // if FEATURE_INTERNAL_TEMPERATURE
    case 'k': return Enum::KFONT1;
    case 'l': return Enum::LCLTIME;
    case 'm': return Enum::MAC;
    case 'n': return Enum::NET;
    case 'o': return Enum::OPERATORISMI;
    case 'p': return Enum::PARTINO;
    case 'r': return Enum::RSSI;
    case 'q': return Enum::QRKOD;
    case 's': return Enum::SAAT;
    case 't': return Enum::TARIH;
...
const __FlashStringHelper * SystemVariables::toFlashString(SystemVariables::Enum enumval)
{
  switch (enumval) {
    ...
    case Enum::FIRMAISMI:          return F("firmaismi");
    ...
    case Enum::MUSTERIISMI:         return F("musteriismi");
    ...
    /*o*/
    case Enum::OPERATORISMI:       return F("operatorismi");
    case Enum::ORTA:               return F("ORTA");

    /*p*/
    case Enum::PARTINO:            return F("partino");
    ...
    case Enum::TOPADET:            return F("topadet");
    case Enum::TOPBRUT:            return F("topbrut"); 
    case Enum::TOPDARA:            return F("topdara");
    case Enum::TOPLAM_DETAY:       return F("toplam_detay");
    ...
    case Enum::URUNISMI:           return F("urunismi");
    case Enum::URUNKOD:            return F("urunkod");
    case Enum::URUNMESAJ:          return F("urunmesaj");
    case Enum::URUNNO:             return F("urunno");
