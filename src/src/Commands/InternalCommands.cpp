...
#if defined(USES_P130) || defined(USES_P131) || defined(USES_P132)
#include "EYZ.h"
#endif

#if defined(USES_P140)
#include "IND.h"
#endif
...
bool InternalCommands::executeInternalCommand()
{
  ...
  switch (cmd) {
    ...
    case ESPEasy_cmd_e::espnowpair:                 COMMAND_CASE_A(Command_Espnow_Pair,    0);               // Rule.h
#endif // ifdef ESP_NOW_ACTIVE
...
#if defined(USES_P130) || defined(USES_P131) || defined(USES_P132)    
    case ESPEasy_cmd_e::eyzart:                     COMMAND_CASE_A(Command_Eyz_Art,        1);               // EYZ.h
    case ESPEasy_cmd_e::eyzdaraekle:                COMMAND_CASE_A(Command_Eyz_Dara_Ekle,  0);               // EYZ.h
    case ESPEasy_cmd_e::eyzdarasil:                 COMMAND_CASE_A(Command_Eyz_Dara_Sil,   0);               // EYZ.h
    case ESPEasy_cmd_e::eyznet:                     COMMAND_CASE_A(Command_Eyz_Net,        0);               // EYZ.h
    case ESPEasy_cmd_e::eyzurunart:                 COMMAND_CASE_A(Command_Eyz_Urun_Art,   12);              // EYZ.h
    case ESPEasy_cmd_e::eyzuruntek:                 COMMAND_CASE_A(Command_Eyz_Urun_Tek,   12);              // EYZ.h
    case ESPEasy_cmd_e::eyzsensor:                  COMMAND_CASE_A(Command_Eyz_Sensor,     0);               // EYZ.h
    case ESPEasy_cmd_e::eyzserino:                  COMMAND_CASE_A(Command_Eyz_Serino,     1);               // EYZ.h
    case ESPEasy_cmd_e::eyztek:                     COMMAND_CASE_A(Command_Eyz_Tek,        1);               // EYZ.h
    case ESPEasy_cmd_e::eyztest:                    COMMAND_CASE_A(Command_Eyz_Test,       1);               // EYZ.h
    case ESPEasy_cmd_e::eyztspl:                    COMMAND_CASE_A(Command_Eyz_tspl,       1);               // EYZ.h
    case ESPEasy_cmd_e::eyzyaz:                     COMMAND_CASE_A(Command_Eyz_Yaz,       10);               // EYZ.h
    case ESPEasy_cmd_e::eyzyazsatir:                COMMAND_CASE_A(Command_Eyz_Yaz_Satir,  1);               // EYZ.h
#endif    
    case ESPEasy_cmd_e::factoryreset:               COMMAND_CASE_R(Command_Settings_FactoryReset, 0);        // Settings.h
#if defined(USES_P120) || defined(USES_P121) || defined(USES_P122)
    case ESPEasy_cmd_e::fyzart:                     COMMAND_CASE_A(Command_Fyz_Art,        2);               // FYZ.h
    case ESPEasy_cmd_e::fyzescpos:                  COMMAND_CASE_A(Command_Fyz_Esc_Pos,    1);
    case ESPEasy_cmd_e::fyzkop:                     COMMAND_CASE_A(Command_Fyz_Kopya,      1);
    case ESPEasy_cmd_e::fyznet:                     COMMAND_CASE_A(Command_Fyz_Net,        0);
    case ESPEasy_cmd_e::fyzurunart:                 COMMAND_CASE_A(Command_Fyz_Urun_Art,   7);
    case ESPEasy_cmd_e::fyzuruntek:                 COMMAND_CASE_A(Command_Fyz_Urun_Tek,   8);
    //case ESPEasy_cmd_e::fyztek:                     COMMAND_CASE_A(Co)
    case ESPEasy_cmd_e::fyztest:                    COMMAND_CASE_A(Command_Fyz_Test,       1);
    case ESPEasy_cmd_e::fyztop:                     COMMAND_CASE_A(Command_Fyz_Top,        1);
    case ESPEasy_cmd_e::fyzyaz:                     COMMAND_CASE_A(Command_Fyz_Yaz,       10);
    case ESPEasy_cmd_e::fyzyazsatir:                COMMAND_CASE_A(Command_Fyz_Yaz_Satir,  1);
#endif 
...
#endif
#if defined(USES_P140)
    case ESPEasy_cmd_e::indelledara:                COMMAND_CASE_R(Command_Ind_Elle_Dara, 1);  // IND.h
    case ESPEasy_cmd_e::inddaraekle:                COMMAND_CASE_R(Command_Ind_Dara_Ekle, 0);  // IND.h
    case ESPEasy_cmd_e::inddarasil:                 COMMAND_CASE_R(Command_Ind_Dara_Sil,  0);  // IND.h
    case ESPEasy_cmd_e::indkaydet:                  COMMAND_CASE_R(Command_Ind_Kaydet,    0);  // IND.h
    case ESPEasy_cmd_e::indseridata:                COMMAND_CASE_R(Command_Ind_Seri_Data, 0);  // IND.h
    case ESPEasy_cmd_e::indsifir:                   COMMAND_CASE_R(Command_Ind_Sifir,     0);  // IND.h
    case ESPEasy_cmd_e::indsifirkal:                COMMAND_CASE_R(Command_Ind_Sifir_Kal, 0);  // IND.h
    case ESPEasy_cmd_e::indyukkal:                  COMMAND_CASE_R(Command_Ind_Yuk_Kal,   1);  // IND.h
#endif  
#ifndef BUILD_NO_DIAGNOSTIC_COMMANDS
