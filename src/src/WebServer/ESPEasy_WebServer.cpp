...
#include "../WebServer/managemesages.h"
...
void WebServerInit()
{
...
#ifdef USES_ESPNOW_MANAGER
  web_server.on(F("/espnow_manager"),          handle_espnow_manager);
  web_server.on(F("/espnow_scan"),             handle_espnow_scan);
  web_server.on(F("/espnow_pair"),             handle_espnow_pair);
  web_server.on(F("/espnow_send"),             handle_espnow_send);
  web_server.on(F("/espnow_broadcast"),        handle_espnow_broadcast);
  web_server.on(F("/espnow_pair_device"),      handle_espnow_pair_device);
  web_server.on(F("/espnow_remove_device"),    handle_espnow_remove_device);
  web_server.on(F("/espnow_pair_discovered"),  handle_espnow_pair_discovered);
  web_server.on(F("/espnow_discovery"),        handle_espnow_discovery);
#endif // USES_ESPNOW_MANAGER
  ...
  web_server.on(F("/urunler"), handle_urunler);
  web_server.on("/saveproduct", HTTP_POST, handle_saveProduct);
  //web_server.on(F("/deleteproduct"), handle_deleteProduct);
  //web_server.on(F("/editproduct"), handle_editProduct);

  web_server.on("/mesajlar", handle_managemesages);
  web_server.on("/savemesajlar", HTTP_POST, handle_savemesages);
  web_server.on("/olusturmesaj", HTTP_GET, handle_newmesages);
