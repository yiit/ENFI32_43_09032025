...
void setup_scr_scr_kaydedildi_2(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->scr_kaydedildi_2, 0, static_cast<int>(LV_PART_MAIN)|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_image_recolor_opa(ui->scr_kaydedildi_2_kaydet_2_img, 255, static_cast<int>(LV_PART_MAIN)|static_cast<int>(LV_STATE_DEFAULT));
    lv_obj_set_style_image_recolor(ui->scr_kaydedildi_2_kaydet_2_img, lv_color_hex(0x2FDA64), static_cast<int>(LV_PART_MAIN)|static_cast<int>(LV_STATE_DEFAULT));
    lv_obj_set_style_image_opa(ui->scr_kaydedildi_2_kaydet_2_img, 255, static_cast<int>(LV_PART_MAIN)|static_cast<int>(LV_STATE_DEFAULT));
