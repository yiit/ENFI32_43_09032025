...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->scr_logo_del = true;
    ui->scr_main_del = true;
    ui->scr_mbtn_del = true;
    ui->scr_fbtn_del = true;
    ui->scr_ubtn_del = true;
    ui->scr_wifi_sta_del = true;
    ui->scr_kaydedildi_del = true;
    ui->scr_kaydedildi_2_del = true;
    ui->scr_kod_del = true;
    ui->scr_menu_del = true;
    ui->scr_ekran_del = true;
    ui->scr_fis_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_scr_logo(ui);
    lv_screen_load(ui->scr_logo);
}
...
void init_keyboard(lv_ui *ui)
{
    if (!ui->g_kb_top_layer) {
        ...
        lv_obj_set_style_anim_time(ui->g_kb_top_layer, 0, 0); // Animasyonları kapat
        lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_Oswald_Reg_20, static_cast<int>(LV_PART_MAIN) | static_cast<int>(LV_STATE_DEFAULT));
        lv_obj_set_style_pad_all(ui->g_kb_top_layer, 2, LV_PART_MAIN);
    }
}
