  ...
  else if (upload.status == UPLOAD_FILE_WRITE)
  {
    ...
    if (upload.totalSize == 0)
    {
      ...
      if (valid) {
        ...
        # endif // if FEATURE_TARSTREAM_SUPPORT
        {
          upload.filename.replace("#fyz#",    "rules/fyz");
          upload.filename.replace("#fyzplu#", "rules/fyzplu");
          upload.filename.replace("#eyz#",    "rules/eyz");
          upload.filename.replace("#eyzplu#", "rules/eyzplu");
          upload.filename.replace("#plu#",    "rules/plu");
          upload.filename.replace("#logo#",   "rules/logo");
          upload.filename.replace("#ind#",    "rules/ind");
          upload.filename.replace("#hrc#",    "rules/hrc");
          upload.filename.replace("#srv#",    "rules/srv");
          upload.filename.replace("#cnt#",    "rules/cnt");
          upload.filename.replace("#cli#",    "rules/cli");
