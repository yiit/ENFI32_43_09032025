...
*/
  ...
  const __FlashStringHelper * serialport[] = {
    F("8N1"),
    F("7E1"),
    F("8O1")
  };
  constexpr int nrserialport = NR_ELEMENTS(serialport);
  const FormSelectorOptions selector0(nrserialport,serialport);
  selector0.addFormSelector(F("Baud Bit"), F("baudbit"), Settings.BaudBit);
...
selector0.addFormSelector(F("Baud Bit1"), F("baudbit1"), Settings.BaudBit1);
...
const __FlashStringHelper * espnowmod[] = {
  F("kapalı"),
  F("client"),
  F("server")
};
constexpr int nrespnowmod = NR_ELEMENTS(espnowmod);
const FormSelectorOptions selector1(nrespnowmod,espnowmod);
selector1.addFormSelector(F("ESPNOW Mod"), F("espnowmod"), Settings.espnow_mod);
//addFormCheckBox(F("Bluetooth Aktif"), F("bluetoothclientaktif"), Settings.bluetooth_aktif);
//addFormTextBox(F("Server ESPNOW Mac Adres"), F("espnowmacaddress"), Settings.espnow_mac_address, 6);
