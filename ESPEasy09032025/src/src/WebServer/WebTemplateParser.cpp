...
#ifndef MENU_INDEX_URUN_VISIBLE
  # define MENU_INDEX_URUN_VISIBLE true
#endif // ifndef MENU_INDEX_SCREEN_VISIBLE

#ifndef MENU_INDEX_MESAJLAR_VISIBLE
  # define MENU_INDEX_MESAJLAR_VISIBLE true
#endif // ifndef MENU_INDEX_SCREEN_VISIBLE
...
const __FlashStringHelper* getGpMenuIcon(uint8_t index) {
  switch (index) {
    ...
    case MENU_INDEX_URUNLER: return F("&#128640;"); // "Products" in Turkish
    case MENU_INDEX_MESAJLAR: return F("&#9993;"); // "Messages" in Turkish
#ifdef FEATURE_TEST
...
const __FlashStringHelper* getGpMenuLabel(uint8_t index) {
  switch (index) {
    ...
    case MENU_INDEX_URUNLER: return F("Ürünler");
    case MENU_INDEX_MESAJLAR: return F("Mesajlar");
#ifdef FEATURE_TEST
...
const __FlashStringHelper* getGpMenuURL(uint8_t index) {
  switch (index) {
    ...
    case MENU_INDEX_URUNLER: return F("/urunler");
    case MENU_INDEX_MESAJLAR: return F("/mesajlar");
    #ifdef FEATURE_TEST
        case MENU_INDEX_TEST: return F("/test");
    #endif
...
bool GpMenuVisible(uint8_t index) {
  switch (index) {
    ...
    case MENU_INDEX_URUNLER: return MENU_INDEX_URUN_VISIBLE; // Always visible
    case MENU_INDEX_MESAJLAR: return MENU_INDEX_MESAJLAR_VISIBLE; // Always visible
    #ifdef FEATURE_TEST
