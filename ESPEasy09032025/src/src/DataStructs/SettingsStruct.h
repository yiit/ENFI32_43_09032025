...
//       uint32_t unused_29                  : 1;  // Bit 29
  ...
  char          srv_prn[30] = {0};
  char          http_prn[30] = {0};
  char          urun_tek_prn[30] = {0};
  char          urun_art_prn[30] = {0};
  char          urun_ek_prn[30] = {0};
  char          urun_top_prn[30] = {0};

  char          urun_adet_tek_prn[30] = {0};
  char          urun_adet_art_prn[30] = {0};
  char          urun_adet_ek_prn[30] = {0};
  char          urun_adet_top_prn[30] = {0};
  ...
  boolean       UseESPNOW = 0;
  int8_t        espnow_mod = 0;
  uint8_t       espnow_mac_address[6] = {0};
